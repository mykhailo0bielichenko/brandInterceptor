...
import { ArrowRight, TrendingUp, Info, ExternalLink } from "lucide-react"
...
export function Hero() {
  ...
  const openChatGPTReport = () => {
    window.open("https://chatgpt.com/c/68758c68-1844-8008-b7fe-4017b61e5588", "_blank", "noopener,noreferrer")
  }
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300 max-w-2xl mx-auto">
            Fully-automated system that discovers emerging casino brands, spins up optimized review sites in minutes,
            and captures organic traffic before brands invest in SEO.
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3">
              ...
              <div className="flex items-center justify-center mb-2">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      onClick={openChatGPTReport}
                      className="ml-2 text-gray-400 hover:text-blue-300 transition-colors"
                    >
            ...
            <div className="text-center">
              <a href="#roi-calculation" className="group">
                <div className="text-3xl font-bold text-white group-hover:text-green-400 transition-colors">72%</div>
